    ...
    return (
        <div className="box">
                ...
                <div className="why-points">
                    <div className="left-side">
                        <div className="why-point">
                            <img src="/src/assets/door.svg" alt="door-image" />
                        ...
                        <div className="why-point">
                            <img src="/src/assets/wallet.svg" alt="wallet-image" />
                            <div className="why-point-details">
                        ...
                        <div className="why-point">
                            <img src="/src/assets/document.svg" alt="document-image" />
                            <div className="why-point-details">
                    ...
                    <div className="right-side">
                        <div className="why-point">
                            <img src="/src/assets/percent.svg" alt="percent-image" />
                            <div className="why-point-details">
                        ...
                        <div className="why-point">
                            <img src="/src/assets/shield.svg" alt="shield-image" />
                            <div className="why-point-details">
                        ...
                        <div className="why-point">
                            <img src="/src/assets/laptop.svg" alt="laptop-image" />
                            <div className="why-point-details">
            ...
            <div className="steps-section">
                ...
                <div className="steps">
                    <div className="step1">
                        <img src="/src/assets/step1.png" alt="step1-image" />
                        <p>Click</p>
                    </div>
                    <div className="step2">
                        <img src="/src/assets/step2.png" alt="step2-image" />
                        <p>Fill Form</p>
                    </div>
                    <div className="step3">
                        <img src="/src/assets/step3.png" alt="step3-image" />
            ...
            <div className="partners-section">
                <img src="/src/assets/Partners.png" alt="partners-image" />
            </div>
        </div>
    )
}
